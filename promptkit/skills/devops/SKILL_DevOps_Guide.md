...
**Owner:** jtisby · **Last reviewed:** 2026-08-30 · **Review cadence:** quarterly

> **This file is the single source of truth.** Copies at `C:\Dev\SKILL_DevOps_Guide.md`
> and `C:\Dev\projects\SKILL_DevOps_Guide.md` are generated by
> `python scripts/sync_agents.py` and carry an AUTO-GENERATED header. Edit here, then
> run the sync. Never fork.
